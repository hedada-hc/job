<!DOCTYPE html>
   ...
   <head>
       <title></title>
       <link rel="stylesheet" href="http://xueyuan.com/packages/admin/AdminLTE/bootstrap/css/bootstrap.min.css">
       <link rel="stylesheet" href="http://xueyuan.com/packages/admin/jssdk/demo/styles/main.css">
        <link rel="stylesheet" href="http://xueyuan.com/packages/admin/jssdk/demo/styles/highlight.css">
<script src="http://xueyuan.com/packages/admin/AdminLTE/plugins/jQuery/jQuery-2.1.4.min.js"></script>
<script src="http://xueyuan.com/packages/admin/jssdk/bootstrap.min.js"></script>
<script src="http://xueyuan.com/packages/admin/jssdk/moxie.js"></script>
<script src="http://xueyuan.com/packages/admin/jssdk/plupload.js"></script>
<script src="http://xueyuan.com/packages/admin/jssdk/plupload.dev.js"></script>
<script src="http://xueyuan.com/packages/admin/jssdk/zh_CN.js"></script>
<script src="http://xueyuan.com/packages/admin/jssdk/demo/scripts/ui.js"></script>
<script src="http://xueyuan.com/packages/admin/jssdk/src/qiniu.js"></script>
<script src="http://xueyuan.com/packages/admin/jssdk/demo/scripts/multiple.js"></script>
<script src="http://xueyuan.com/packages/admin/jssdk/demo/scripts/highlight.js"></script>
<script src="http://xueyuan.com/packages/admin/jssdk/demo/scripts/main.js"></script>
   </head>
   <body>
...
$(function(){
                        ...
                        var uploader = Qiniu.uploader({
                            ...
                            uptoken_url: '{{url("/uptoken")}}',            //Ajax请求upToken的Url，**强烈建议设置**（服务端提供）
